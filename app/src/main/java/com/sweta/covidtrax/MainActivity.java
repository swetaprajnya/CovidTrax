...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    com.sweta.covidtrax.Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrecovered=findViewById(R.id.totalrecoverd);
    ...
    private void updateGraph(int active, int total, int recovered, int deaths) {
      mpiechart.clearChart();
        ...
        mpiechart.addPieSlice(new PieModel("Active",active,Color.parseColor("#FF4CA50")));
